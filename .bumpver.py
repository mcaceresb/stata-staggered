...
config_files = [
    ...
    ('staggered.pkg', 'v {major}.{minor}.{patch}'),
    ('staggered.pkg', 'd Distribution-Date: {date:%Y%m%d}'),
    ('stata.toc', 'v {major}.{minor}.{patch}'),
    ('doc/staggered.sthlp', 'version {major}.{minor}.{patch} {date:%d%b%Y}'),
    ('src/ado/staggered.ado', 'version {major}.{minor}.{patch} {date:%d%b%Y}')
]
